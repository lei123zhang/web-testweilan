module.exports = {
    ...
    otc:{
        ...
        identBusiness:{
            applyIdentBusiness:'Please apply for the certification business first',
    ...
    uc:{
      login:{
        ...
        loginvalidate:'Please input email',
      ...
      regist:{
        ...
        editCountry:'Please fill in the country',
      },
      safe:{
        ...
        googelCode:'Google verification code',
        googelTip:'Used to extract coins and modify fund password for security verification.',
        googelTip1:'Key Used to retrieve Google Authenticator. Please keep it properly.',
        googelRequired:'Please enter the Google Authenticator code',
        googelBind:'Please bind Google verification first',
        secret:'Secret',
        account:'Account',
      },
      account:{
    ...
    description: {
        ...
        message3: 'weilan Exchange supports 10,000 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'weilan Exchange weilan Mobile Office Mobile Client Focused on Handheld Trading Experience',
        message6:'Authoritative trading platform',
        message7:'Block chain project',
        message8:'Fast and convenient'
    },
    footer: {
        gsmc:'Leading global digital asset trading platform',
