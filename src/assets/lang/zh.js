module.exports = {
    ...
    uc:{
      ...
      safe:{
        ...
        googel:'谷歌验证器',
        googelCode:'谷歌验证码',
        googelTip:'用于提币、修改资金密码进行安全验证。',
        googelTip1:'密钥 用于找回谷歌验证器，请妥善保存。',
        googelRequired:'请输入谷歌验证器 中的验证码',
        googelBind:'请先绑定谷歌验证',
        secret:'密钥',
        account:'账户',
    ...
    description: {
        ...
        message3: '支持每秒10000笔交易，给用户带来酣畅淋漓\n的交易体验',
        message4: '多终端APP，方寸间轻松交易',
        message5: '交易平台手机客户端，专注掌上交易体验',
        message6:'权威交易平台',
        message7:'区块链项目',
        message8:'快速便捷'
    },
