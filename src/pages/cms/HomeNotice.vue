  ...
  export default {
    data() {
      return {
        title:"weilan 上线公告",
        time:"2018-03-06",
        content:'<h4 class="h4">《全球专业站法币交易平台服务协议》（以下简称“本协议”）是全球专业站（www.jiucaibtc.com）（以下\n' +
        '          简称“本网站”）用户协议的补充部分，适用于本网站的下属子网站全球专业站法币交易平台（otc.huobi.pro）\n' +
        '          服务。本网站的用户协议及其他条款继续适用于本网站所有用户。在您通过本网站继续下一步操作前，请您务必仔细阅 读并透彻理解本协议。如您通过本网站继续下一步操作，或以任何方式使用全球专业站法 币交易平台交易服务，\n' +
        ...
        '        <h4>一、 定义 </h4>\n' +
        '        <p>\n' +
        '          1.1.全球专业站法币交易平台（以下简称“法币交易平台”）：是全球专业站设立关于数字资产场外交易的平台，您可以在法币交易平台创建出售/购买数字资产的卖单/买单，与意向交易对方达成交易，以满足用户间交换数字资产\n' +
        '          的需求。</p>\n' +
        '        <p>1.2.全球专业站法币交易平台规则（以下简称“法币交易平台规则”）：包括在所有本网站及法币交易平台已经发布 及后续发布的用户协议、本协议及其他协议或条款、规则、实施细则、产品流程说明、公告等。</p>\n' +
