                                ...
                                <div class="detail-list">
                                    <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate" :label-width="85">
                                      <Row>
                                        ...
                                        <img v-if='isAliImg' :alt="$t('uc.account.imgtip')" id="aliImg" style="width: 200px;height: 200px;" :src="aliImg">
                                        <img v-else :alt="$t('uc.account.imgtip')" id="aliImg" style="width: 50px;height: 50px;" :src="aliImg">
                                        <div class="acc_sc">
                                    ...
                                    <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate" :label-width="85">
                                      <Row>
                                        <Col span="8">
                                          ...
                                          <!-- <img :alt="$t('uc.account.imgtip')" id="weImg" style="width: 200px;height: 300px;" :src="weImg"> -->
                                            <img v-if='isWeImg' :alt="$t('uc.account.imgtip')" id="weImg" style="width: 200px;height: 200px;" :src="weImg">
                                            <img v-else  :alt="$t('uc.account.imgtip')" id="weImg" style="width: 50px;height: 50px;" :src="weImg">
                                          <div class="acc_sc">
...
export default {
    ...
    data() {
        ...
        return {
            ...
            aliImg:require('../../assets/images/transparent.png'),
            isAliImg:false,
            aliPreview:'',
            weImg:require('../../assets/images/transparent.png'),
            isWeImg:false,
            wePreview:'',
            isNoName: true,
            msg: '',
    ...
    methods: {
        aliHandleSuccess (res, file) {
            ...
            // this.aliImg=this.aliPreview=this.url+res.data;
            this.isAliImg=true;
            this.aliImg=this.aliPreview=this.url+res.data;
        },
        weHandleSuccess (res, file) {
            // this.weImg=this.wePreview=this.url+res.data;
            this.isWeImg=true;
            this.weImg=this.wePreview=this.url+res.data;
        },
        handleSubmit(name) {
        ...
        getAccount() {
            ...
            this.$http.post(this.host + '/uc/approve/account/setting').then(response => {
                ...
                if (resp.code == 0) {
                    ...
                    if(this.aliImg==null || this.aliImg==''){
                        this.aliImg=require('../../assets/images/transparent.png');
                        this.isAliImg=false;
                       
                    }else{
                        this.isAliImg=true;
                    }
                    if(this.weImg==null || this.weImg==''){
                        this.weImg=require('../../assets/images/transparent.png');
                        this.isWeImg=false;
                    }else{
                        this.isWeImg=true;
                    }
