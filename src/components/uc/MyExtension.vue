            ...
            <div class="bill_box rightarea padding-right-clear record account-box">
              <ButtonGroup>
                ...
                <div class="message" v-else-if="this.changeActive==1">
                    <Table stripe :columns="tablePromoteFriends" :data="dataPromoteFriends" :loading="loading" :no-data-text="$t('common.nodata')" ></Table>
                </div>
                <div class="message" v-else>
                  <Table stripe :columns="tablePromoteMoney" :data="dataPromoteMoney" :loading="loading" :no-data-text="$t('common.nodata')" ></Table>
...
export default {
    ...
    methods: {
        ...
        qrcodeM(){
            ...
            this.qrcode.value="http://focctest.io/#/register?agent="+promotionCode;
        },
        onCopy(e) {
