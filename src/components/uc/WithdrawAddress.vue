        ...
        <div class="nav-right col-xs-12 col-md-10 padding-right-clear">
            <div class="bill_box rightarea padding-right-clear record">
                <section class="trade-group merchant-top">
                    ...
                    <h1 class="tips-word">{{$t('uc.finance.withdraw.addressmanager')}}</h1>
                </section>
                <section>
                    <div class="table-inner action-box open">
                        ...
                        <div class="btnbox">
                            <Button id="addrSubmit" @click='addAddr' size="large" type="primary" style="height:40px;width:20%">{{$t('uc.finance.withdraw.add')}}</Button>
                        </div>
    ...
    data() {
      var that = this;
        return {
            ...
            ruleValidate: {
                mobileNo: [
                    { required: this.validPhone, message: this.$t('uc.finance.withdraw.telerr'), trigger: 'blur' }
                ],
                vailCode2: [
                    { required: this.validPhone, message: this.$t('uc.finance.withdraw.codeerr'), trigger: 'change' }
                ],
                email: [
                    { required: this.validEmail, type: 'email', message: this.$t('uc.finance.withdraw.emailerr'), trigger: 'blur' },
                ],
                vailCode1: [
                    { required: this.validEmail, message: this.$t('uc.finance.withdraw.codeerr'), trigger: 'change' }
                ],
