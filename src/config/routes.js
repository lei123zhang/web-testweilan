...
import exchargeruleEn from '../pages/cms/ExchargeRuleEn' /*交易规则*/
import userprotocol from '../pages/cms/UserProtocol' /*使用协议*/
import userprotocolEn from '../pages/cms/UserProtocolEn' 
import feenote from '../pages/cms/FeeNote' /*资费说明*/
import feenoteEn from '../pages/cms/feenoteEn' /*资费说明*/
...
export default [
    ...
    {
        path: '/about-protocolEn',
        component: userprotocolEn
    },
    {
        path: '/about-fee',
        component: feenote
